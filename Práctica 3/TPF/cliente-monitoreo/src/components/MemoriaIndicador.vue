                ...
                chart: {
                    ...
                    events: {
                        load: function () {
                            ...
                            socket.on('mem-used', function(num){
                                var x = (new Date()).getTime();
                                console.log(num.utilizada)
                                series.addPoint([x, num.utilizada], true, true);
                            }); 
                        }
                    },
                ...
                chart: {
                    ...
                    events: {
                        load: function () {
                            ...
                            var series = this.series[0];
                            socket.on('mem-free', function(num){
                                var x = (new Date()).getTime();
                                console.log(num.libre)
                                series.addPoint([x, num.libre], true, true);
                            }); 
                        }
                    },
